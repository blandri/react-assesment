...
export const Form = () => {
 ...
 return (
    <Container sx={{display: 'flex', justifyContent: 'center'}}>
        <Box mt={35} sx={{width: '1304px'}}>
        <Typography variant="h5" color="primary" fontWeight={700}>Offloading car</Typography>
        ...
        <Stack direction="row" alignItems="center" gap={2}>
            ...
            <AddBox color="primary" sx={{fontSize: '45px'}} />
        </Stack>
        </Box>
        <Box>
        ...
        <Stack direction="row" alignItems="center" gap={2}>
            ...
            <IconButton onClick={()=> setOpenH(true)}>
              <AddBox color="primary" sx={{fontSize: '45px'}} />
            </IconButton>
        </Stack>
        </Box>
        </Box>
        <Box mt={8} borderBottom={1} paddingBottom={2} sx={{borderColor: 'primary.main'}}>
            <Stack direction={'row'} justifyContent={'space-between'} alignItems="center">
            <Typography fontWeight={700} color="primary">Product details</Typography>
            <Button onClick={()=> handleOpen()} variant="outlined" startIcon={<Add />}>Add new product</Button>
            </Stack>
        </Box>
        <Box mt={4} borderLeft={8} borderBottom={1} borderTop={1} borderRight={1} p={2} borderRadius={1} sx={{backgroundColor: 'rgba(38, 170, 225, 0.04)', borderColor: 'primary.main'}}>
            <Stack direction={'row'} justifyContent={'space-between'} alignItems="center">
            <Typography>Sugar</Typography>
            <Typography>23 items</Typography>
            <Typography>50 KG/item</Typography>
            <IconButton>
                <Check color="primary" sx={{width: '43px', height: '35px'}}/>
            </IconButton>
            </Stack>
        </Box>
        <Box mt={4} sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
            <Stack gap={5}>
            <Box>
            <Typography>Select product name</Typography>
            <Stack direction="row" alignItems="center" gap={2}>
            ...
            <FormControl>
               <Typography>Weight/item</Typography>
               <TextField label="Enter product weight/item" variant="outlined" sx={textFieldStyles} />
            </FormControl>
            </Stack>
            <Stack gap={5}>
                <FormControl>
                    <Typography>Number of items</Typography>
                    <TextField placeholder="Enter number of items" variant="outlined" sx={textFieldStyles} />
                </FormControl>
                <FormControl>
                    <Typography>Price/item (Optional)</Typography>
                    <TextField placeholder="Enter number of items" variant="outlined" sx={textFieldStyles} />
                </FormControl>
                <Button variant="contained" sx={{color: 'white', width: '113px',height: '29px', borderRadius: '5px', fontSize: '9px'}}>Save product</Button>
            </Stack>
        </Box>
        <Box mt={6}>
            <Typography>Upload supporting document</Typography>
            <Box mt={1} sx={{display: 'flex', flexDirection: 'column', gap: '25px',justifyContent: 'center', alignItems: 'center' ,border: '1px dashed grey', width: '1304px', height: '160.83px', backgroundColor: '#F8F8F8', borderRadius: '8.4px' }}>
            <SvgIcon>
        ...
        <Stack mt={6} direction="row" justifyContent="space-between">
            <Button variant="contained" sx={{color: 'white', background: '#333333', paddingX: '30px', paddingY: '12px', width: 'fit-content', borderRadius: '10px'}}>Cancel</Button>
            <Button variant="contained" sx={{color: 'white', paddingX: '30px', paddingY: '12px', width: 'fit-content', borderRadius: '10px'}}>Next</Button>
        </Stack>
    </Box>
