 ...
 return (
    <Container sx={{display: 'flex', justifyContent: 'center'}}>
        ...
        <Box mt={6} sx={{width: '100%'}}>
            ...
            <Box mt={1} sx={{display: 'flex', flexDirection: 'column', gap: '25px',justifyContent: 'center', alignItems: 'center' ,border: '1px dashed grey', width: '100%', height: '130px', backgroundColor: '#F8F8F8', borderRadius: '8.4px' }}>
            <SvgIcon>
